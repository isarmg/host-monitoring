...
echo Example from the repository root: clients\host-monitor\packaging\windows\wix\build-msi.cmd 0.9.1 target\x86_64-pc-windows-msvc\release\host-monitor.exe target\x86_64-pc-windows-msvc\release\host-monitor-maintenance.exe target\x86_64-pc-windows-msvc\release\host-monitor-tray.exe 1>&2
exit /b 2
