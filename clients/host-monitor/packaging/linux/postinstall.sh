...
agent_binary=/usr/bin/host-monitor
...
[ "$("$agent_binary" --version)" = "host-monitor $package_version" ] ||
...
# existing account is accepted only when the current 0.8.0 marker binds its
