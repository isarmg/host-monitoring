...
export function AgentInstances({
  ...
  return (
    <section className="section-band agent-instances" aria-live="polite">
      {createMutation.isPending ? <InlineNotice tone="warn" text="正在创建 host-m-agent 邀请…" /> : null}
      {cancelMutation.isPending ? <InlineNotice tone="warn" text="正在取消 host-m-agent 邀请…" /> : null}
