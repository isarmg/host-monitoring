...
if not "%DETECTED_AGENT_VERSION%"=="host-m-agent %PRODUCT_VERSION%" (
...
dotnet build "%SCRIPT_ROOT%HostMAgent.Installer.wixproj" ^
...
echo Example: build-msi.cmd 0.5.0 ..\..\..\target\x86_64-pc-windows-msvc\release\host-m-agent.exe ..\..\..\target\x86_64-pc-windows-msvc\release\host-m-agent-maintenance.exe ..\..\..\target\x86_64-pc-windows-msvc\release\host-m-agent-tray.exe 1>&2
exit /b 2
