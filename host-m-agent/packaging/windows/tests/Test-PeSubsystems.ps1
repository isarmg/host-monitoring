...
Assert-PeSubsystem `
    -LiteralPath (Join-Path $ReleaseRoot "host-m-agent.exe") `
    -ExpectedSubsystem 3
Assert-PeSubsystem `
    -LiteralPath (Join-Path $ReleaseRoot "host-m-agent-maintenance.exe") `
    -ExpectedSubsystem 2
Assert-PeSubsystem `
    -LiteralPath (Join-Path $ReleaseRoot "host-m-agent-tray.exe") `
    -ExpectedSubsystem 2
