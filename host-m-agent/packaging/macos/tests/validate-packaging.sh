...
for script in \
  ...
  "$packaging_dir/host-m-agent-logrotate" \
...
plutil -lint "$packaging_dir/org.sarmg.hostmagent.plist"
plutil -lint "$packaging_dir/org.sarmg.hostmagent.logrotate.plist"
